...
namespace kinematics {
	...
	* Construct a linkage.
	*/
	Kinematics LinkageSynthesisWattI::constructKinematics(const std::vector<glm::dvec2>& points, const Object25D& moving_body, const std::vector<Object25D>& fixed_bodies) {
		Kinematics kin;
