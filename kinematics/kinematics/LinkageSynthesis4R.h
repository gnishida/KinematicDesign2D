...
namespace kinematics {
	...
	public:
		...
		double calculateCost(Solution& solution, const Object2D& body_pts, const cv::Mat& dist_map, const BBox& dist_map_bbox, const std::vector<double>& weights);
		Kinematics constructKinematics(const std::vector<glm::dvec2>& points, const Object2D& body_pts, const std::vector<Object2D>& fixed_body_pts);
		...
		bool checkCollision(const std::vector<glm::dmat3x3>& poses, const std::vector<glm::dvec2>& points, const std::vector<Object2D>& fixed_body_pts, const Object2D& body_pts, const std::vector<glm::dvec2>& linkage_avoidance_pts);
