...
namespace kinematics {
	...
	public:
		...
		virtual double calculateCost(Solution& solution, const Object2D& body_pts, const cv::Mat& dist_map, const BBox& dist_map_bbox, const std::vector<double>& weights) = 0;
	};
