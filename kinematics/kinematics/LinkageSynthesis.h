...
namespace kinematics {
	...
	public:
		...
		virtual Kinematics constructKinematics(const std::vector<glm::dvec2>& points, const Object25D& body_pts, const std::vector<Object25D>& fixed_body_pts) = 0;
