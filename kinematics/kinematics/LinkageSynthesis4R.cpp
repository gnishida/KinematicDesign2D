...
namespace kinematics {
	...
	*/
	...
	double LinkageSynthesis4R::calculateCost(Solution& solution, const Object2D& body_pts, const cv::Mat& dist_map, const BBox& dist_map_bbox, const std::vector<double>& weights) {
		double dist = 0;
