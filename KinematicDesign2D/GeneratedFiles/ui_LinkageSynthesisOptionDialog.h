...
public:
    ...
    void setupUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        LinkageSynthesisOptionDialog->resize(352, 461);
        ...
        pushButtonOK->setGeometry(QRect(60, 420, 91, 31));
        pushButtonCancel = new QPushButton(LinkageSynthesisOptionDialog);
        pushButtonCancel->setObjectName(QStringLiteral("pushButtonCancel"));
        pushButtonCancel->setGeometry(QRect(200, 420, 91, 31));
        ...
        groupBox_2->setGeometry(QRect(20, 200, 311, 111));
        ...
        groupBox_3->setGeometry(QRect(20, 320, 311, 91));
        ...
        label_18->setGeometry(QRect(70, 170, 141, 16));
