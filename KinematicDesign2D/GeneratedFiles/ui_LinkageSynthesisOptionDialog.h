...
public:
    ...
    void setupUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        LinkageSynthesisOptionDialog->resize(352, 627);
        ...
        pushButtonOK->setGeometry(QRect(60, 580, 91, 31));
        pushButtonCancel = new QPushButton(LinkageSynthesisOptionDialog);
        pushButtonCancel->setObjectName(QStringLiteral("pushButtonCancel"));
        pushButtonCancel->setGeometry(QRect(200, 580, 91, 31));
        ...
        label_18->setGeometry(QRect(70, 310, 141, 16));
        ...
        checkBox4RLinkage->setGeometry(QRect(30, 10, 121, 17));
        ...
        checkBoxSliderCrank->setGeometry(QRect(170, 10, 121, 17));
    ...
    void retranslateUi(QDialog *LinkageSynthesisOptionDialog)
    {
        ...
        groupBox_3->setTitle(QApplication::translate("LinkageSynthesisOptionDialog", "Particle filter:", Q_NULLPTR));
        ...
        label_18->setText(QApplication::translate("LinkageSynthesisOptionDialog", "Min. transmission angle:", Q_NULLPTR));
